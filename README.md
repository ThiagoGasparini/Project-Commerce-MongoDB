...
<details>
  ...
  Nesse projeto, foi trabalhado com o banco de dados `commerce`, que contém dados do cardápio do **McDonald's**, como ingredientes, valores nutricionais e dados fictícios de vendas. 
</details>
...
<details>
  ...
  - ⚠ **Todos os arquivos foram criados dentro da pasta `challenges`** ⚠

  Esse projeto possuiu uma série de desafios com diferentes níveis de complexidade. Cada desafio foi resolvido em seu arquivo próprio. Para isso:

  1. Foi criado o diretório `challenges` com um arquivo chamado `desafioN.js`, em que N é o número do desafio.

  2. No arquivo `desafioN.js` foi contido apenas o código MQL (_Mongo Query Language_) do desafio resolvido.
